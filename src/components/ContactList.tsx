  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className="flex justify-center">
        <Card className="flex w-fit scale-75 transform flex-col items-center justify-center overflow-hidden rounded-xl transition-all duration-300 hover:shadow-2xl sm:scale-100">
          <CardHeader className="relative rounded-t-xl p-0">
            <div className="h-28 rounded-t-xl bg-[url('/public/contact-background.jpg')] bg-cover bg-no-repeat text-transparent">
